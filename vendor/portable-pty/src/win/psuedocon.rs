...
impl PsuedoCon {
    ...
    pub fn spawn_command(&self, cmd: CommandBuilder) -> anyhow::Result<WinChild> {
        ...
        // fresh-gui: hide the console window ConPTY would otherwise flash.
        // CREATE_NO_WINDOW is not used here; it prevents the pseudoconsole's
        // conhost helper from starting, so the shell would have no I/O.
        si.StartupInfo.dwFlags = STARTF_USESTDHANDLES | STARTF_USESHOWWINDOW;
        si.StartupInfo.wShowWindow = SW_HIDE as _;
